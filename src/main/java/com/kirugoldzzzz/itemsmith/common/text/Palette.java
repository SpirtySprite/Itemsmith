package com.kirugoldzzzz.itemsmith.common.text;
...
public final class Palette {
    ...
    public static String PRIMARY_HEX = "#F59E5B";
    public static String SECONDARY_HEX = "#FCD34D";
    ...
    private static TagResolver resolver() {
        return TagResolver.resolver(
                ...
                Placeholder.parsed("brand", "<" + GRADIENT_BRAND + "><b>Itemsmith</b></gradient>"));
    }
